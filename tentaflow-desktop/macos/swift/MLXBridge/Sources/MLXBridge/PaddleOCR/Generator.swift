...
public class PaddleOCRVLGenerator {
    ...
    public func generate(
        ...
        var logits = model.forward(
            ...
            gridH: processedImages.gridH,
            gridW: processedImages.gridW,
            cache: cache
        )
    ...
    public func generate(
        ...
        let gridH = imageHeight / patchSize
        let gridW = imageWidth / patchSize
        let numImageTokens = (gridH / mergeSize) * (gridW / mergeSize)
