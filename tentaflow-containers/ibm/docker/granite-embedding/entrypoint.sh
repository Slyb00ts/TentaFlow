...
# =============================================================================
# Plik: entrypoint.sh
# Opis: vLLM w trybie embeddings (vllm --task embed), direct-http (bez sidecara).
#       Core gada HTTP wprost do host-mapped portu. vLLM serwuje
#       /v1/embeddings. Bind 0.0.0.0 WEWNATRZ kontenera: ruch z docker-publish
#       trafia na interfejs kontenera, nie na jego loopback.
# =============================================================================
