...
#       sidecara). vLLM laduje jina-reranker-v3 i serwuje /v1/rerank + /v1/score
#       na 0.0.0.0:${VLLM_PORT}. --trust-remote-code bo architektura Jina
#       dostarcza wlasny kod modelu w repo HF.
# =============================================================================

set -uo pipefail

MODEL="${MODEL:?MODEL env required, np. 'jinaai/jina-reranker-v3'}"
