...
/// <summary>
/// Tryby wyszukiwania RAG (można łączyć jako flagi).
/// </summary>
[Flags]
public enum SearchMode : uint
{
    /// <summary>Wyszukiwanie pełnotekstowe (Tantivy BM25)</summary>
    FullTextSearch = 0x01,

    /// <summary>Wyszukiwanie wektorowe (HNSW + embeddings)</summary>
    VectorSearch = 0x02,

    /// <summary>Hierarchical RAG (knowledge graph + multi-level retrieval)</summary>
    HiRAG = 0x04,

    /// <summary>Graph Semantic Workspace (episodic memory + reasoning)</summary>
    GSW = 0x08,
}

/// <summary>
/// Informacje o pojedynczym chunk'u ze wyników RAG.
/// Chunk może należeć do wielu dokumentów (przez aliasy/soft links).
/// </summary>
public sealed class RagChunkInfo
{
    ...
    /// <summary>
    /// Score podobieństwa (0.0-1.0, cosine similarity).
    /// </summary>
    ...
    /// </summary>
    public required IReadOnlyList<ChunkDocument> Documents { get; init; }
}
...
public sealed class ChunkDocument
{
    ...
    /// <summary>
    /// Metadane specyficzne dla tego dokumentu (key-value pairs).
    /// </summary>
    public IReadOnlyDictionary<string, string> Metadata { get; init; } = new Dictionary<string, string>();
}

/// <summary>
/// Wynik zapytania RAG (Retrieval Augmented Generation).
/// </summary>
public sealed class RagResult
{
    /// <summary>
    /// Pobrany kontekst lub tekst odpowiedzi.
    /// </summary>
    ...
    /// </summary>
    public uint ChunksFound { get; init; }

    /// <summary>
    /// Czy wymagane jest dalsze przetwarzanie przez LLM.
    /// </summary>
    public bool RequiresLlm { get; init; }

    /// <summary>
    /// Szczegółowe informacje o znalezionych chunkach (z similarity score).
    /// </summary>
    public IReadOnlyList<RagChunkInfo> Chunks { get; init; } = [];
}

/// <summary>
/// Wynik requestu indeksowania dokumentu.
/// </summary>
public sealed class IngestResult
{
    ...
    /// <summary>
    /// Liczba utworzonych wektorów.
    /// </summary>
    public uint VectorCount { get; init; }

    /// <summary>
    /// Całkowity czas przetwarzania w milisekundach.
    /// </summary>
    public uint TotalMs { get; init; }
}

/// <summary>
/// Status indeksowania dokumentu.
/// </summary>
public enum IngestionStatus
{
    /// <summary>
    /// Dokument został pomyślnie zindeksowany.
    /// </summary>
    Success = 0,

    /// <summary>
    /// Dokument już istnieje (dokładny duplikat - ta sama zawartość i doc_id).
    /// </summary>
    Duplicate = 1,

    /// <summary>
    /// Dokument został zaktualizowany (reindeksacja).
    /// </summary>
    Updated = 2,

    /// <summary>
    /// Utworzono dowiązanie do istniejącego dokumentu (ta sama zawartość, inny doc_id).
    /// Zamiast re-indeksowania, utworzono soft link do oryginału.
    /// </summary>
    LinkedToDuplicate = 3,

    /// <summary>
    /// Indeksowanie nie powiodło się z błędem.
    /// </summary>
    Error = 4
}
