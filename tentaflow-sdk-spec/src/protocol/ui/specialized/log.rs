...
impl VirtualizedLog {
    ...
    pub fn into_component(self, id: impl Into<String>) -> Result<Component, IntoComponentError> {
        ...
        if let Some(m) = &self.max_height { e.push((10, encode_to_value(m)?)); }
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut events_path = None; let mut variant = None;
        let mut max_buffer_events = None; let mut auto_scroll = None;
        let mut searchable = None; let mut filter_levels = None;
        let mut show_timestamps = None; let mut show_source = None;
        let mut copyable = None; let mut height = None;
        let mut max_height = None; let mut density = None;
        ...
        Ok(VirtualizedLog {
            events_path: events_path.ok_or_else(|| missing_field("VirtualizedLog", "events_path"))?,
            ...
            auto_scroll: auto_scroll.ok_or_else(|| missing_field("VirtualizedLog", "auto_scroll"))?,
            searchable: searchable.ok_or_else(|| missing_field("VirtualizedLog", "searchable"))?,
            filter_levels: filter_levels.ok_or_else(|| missing_field("VirtualizedLog", "filter_levels"))?,
            show_timestamps: show_timestamps.ok_or_else(|| missing_field("VirtualizedLog", "show_timestamps"))?,
            show_source: show_source.ok_or_else(|| missing_field("VirtualizedLog", "show_source"))?,
