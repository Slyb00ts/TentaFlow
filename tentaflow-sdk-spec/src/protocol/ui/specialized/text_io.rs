...
impl CodeEditor {
    ...
    pub fn into_component(self, id: impl Into<String>) -> Result<Component, IntoComponentError> {
        ...
        if let Some(v) = &self.max_height_px { e.push((7, encode_to_value(v)?)); }
        ...
        if let Some(v) = &self.linting_action_id { e.push((12, encode_to_value(v)?)); }
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut bind_path = None; let mut language = None;
        let mut read_only = None; let mut line_numbers = None;
        let mut word_wrap = None; let mut theme = None;
        let mut min_height_px = None; let mut max_height_px = None;
        let mut tab_size = None; let mut indent_with_tabs = None;
        let mut bracket_matching = None; let mut autocomplete = None;
        ...
        Ok(CodeEditor {
            ...
            line_numbers: line_numbers.ok_or_else(|| missing_field("CodeEditor", "line_numbers"))?,
            word_wrap: word_wrap.ok_or_else(|| missing_field("CodeEditor", "word_wrap"))?,
            theme: theme.ok_or_else(|| missing_field("CodeEditor", "theme"))?,
            min_height_px: min_height_px.ok_or_else(|| missing_field("CodeEditor", "min_height_px"))?,
            max_height_px,
            // §8 0x0607 default: tab_size = 2.
            tab_size: tab_size.unwrap_or(2),
            indent_with_tabs: indent_with_tabs.ok_or_else(|| missing_field("CodeEditor", "indent_with_tabs"))?,
            bracket_matching: bracket_matching.ok_or_else(|| missing_field("CodeEditor", "bracket_matching"))?,
            autocomplete: autocomplete.ok_or_else(|| missing_field("CodeEditor", "autocomplete"))?,
            linting_action_id,
        })
    }
}
...
impl Terminal {
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut stream_id = None; let mut rows = None;
        let mut cols = None; let mut theme = None;
        let mut searchable = None; let mut copyable = None;
