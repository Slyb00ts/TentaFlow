...
impl ImageGallery {
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut images_path = None; let mut columns = None;
        let mut aspect_ratio = None; let mut gap = None;
        let mut lightbox = None; let mut lazy_load = None;
        ...
        Ok(ImageGallery {
            ...
            aspect_ratio: aspect_ratio.ok_or_else(|| missing_field("ImageGallery", "aspect_ratio"))?,
...
impl Carousel {
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut items_path = None; let mut current_index_path = None;
        let mut autoplay = None; let mut autoplay_ms = None;
        let mut r#loop = None; let mut show_indicators = None;
        let mut show_arrows = None; let mut gestures = None;
        for (k, v) in &c.fields.0 {
            match k {
        ...
        Ok(Carousel {
            ...
            current_index_path: current_index_path.ok_or_else(|| missing_field("Carousel", "current_index_path"))?,
            ...
            show_indicators: show_indicators.ok_or_else(|| missing_field("Carousel", "show_indicators"))?,
...
impl PdfViewer {
    ...
    pub fn into_component(self, id: impl Into<String>) -> Result<Component, IntoComponentError> {
        ...
        if let Some(p) = &self.page_path { e.push((1, encode_to_value(p)?)); }
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut src_ref = None; let mut page_path = None;
        let mut height = None; let mut zoom_mode = None; let mut searchable = None;
        for (k, v) in &c.fields.0 {
            match k {
