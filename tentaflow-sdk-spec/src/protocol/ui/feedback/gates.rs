...
impl GateScreen {
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut icon = None; let mut title = None; let mut message = None;
...
impl ConfirmationDialog {
    ...
    pub fn into_component(self, id: impl Into<String>) -> Result<Component, IntoComponentError> {
        ...
        if let Some(v) = &self.require_typing { e.push((7, encode_to_value(v)?)); }
        Ok(component(Self::TAG, id, e))
    }
    ...
    pub fn try_from_component(c: &Component) -> Result<Self, minicbor::decode::Error> {
        ...
        let mut title = None; let mut message = None; let mut icon = None;
        let mut tone = None; let mut confirm_label = None; let mut cancel_label = None;
        let mut destructive = None; let mut require_typing = None;
        for (k, v) in &c.fields.0 {
            match k {
        ...
        Ok(ConfirmationDialog {
            ...
            confirm_label: confirm_label.ok_or_else(|| missing_field("ConfirmationDialog", "confirm_label"))?,
            cancel_label: cancel_label.ok_or_else(|| missing_field("ConfirmationDialog", "cancel_label"))?,
            destructive: destructive.ok_or_else(|| missing_field("ConfirmationDialog", "destructive"))?,
            require_typing,
        })
    }
}
