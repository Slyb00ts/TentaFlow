...
//
// `#/tentabus?instance=…&tab=…&topic=…&group=…&source=…` is written with the router's
 ...
 * so a hand-edited link cannot open a topic under the wrong tab.
 */
...
export function routeParams({ instance, tab, topic = null, group = null, groupTopic = null, dlqTopic = null }) {
  const out = {};
