...
const USED_KEYS = [
  ...
  'filter_engine_all', 'filter_scope', 'filter_scope_all', 'install_error',
  ...
  'kv_provider_account', 'kv_credential_stored', 'kv_status', 'list_empty', 'list_foot',
  ...
  'sessions_people', 'sessions_title', 'sessions_title_scope', 'settings_title', 'since_hours', 'since_minutes',
  'status_active_any',
