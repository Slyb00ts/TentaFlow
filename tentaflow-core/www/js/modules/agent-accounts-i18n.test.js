...
const USED_KEYS = [
  ...
  'err_key_required', 'err_name_required', 'error_unknown', 'field_api_key',
  ...
  'login.action_cancel', 'login.action_copy', 'login.action_open', 'login.action_start',
  'login.action_submit', 'login.copied', 'login.copy_failed', 'login.field_code_placeholder',
  'login.field_node', 'login.lost', 'login.result_failed', 'login.result_ok',
  'login.result_ok_as', 'login.result_verifying', 'login.step_code', 'login.step_open',
  'login.step_open_hint', 'login.step_result', 'login.step_result_hint', 'login.step_start',
  'login.step_start_hint', 'login.title', 'node_accounts', 'node_accounts_none', 'node_offline',
  'node_online', 'node_state_current', 'node_state_error', 'node_state_materializing',
  'node_state_on_first_use', 'node_state_stale', 'nodes_empty', 'nodes_title', 'own_account',
  ...
  'session_end_confirm_title', 'session_ended', 'sessions_empty', 'sessions_title',
  'settings_title', 'since_hours', 'since_minutes', 'status_active_any',
