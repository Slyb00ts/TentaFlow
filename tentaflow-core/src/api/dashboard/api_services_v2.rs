// ============ File: api/dashboard/api_services_v2.rs — REST view over services_v2 + model_registry_v2 ============
//
// Phase 5 thin GUI surface for the unified services pipeline. The REST shape
// is intentionally minimal: a flat list of supervised services plus their
...
/// to `model_registry_v2`. The legacy REST DELETE keeps acting on the legacy
/// `services` table; this handler is the v2 equivalent for unified services.
