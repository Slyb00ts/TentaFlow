...
pub const COMMON_POLISH_NAMES: &[&str] = &[
    ...
    "Jan", "Piotr", "Paweł", "Andrzej", "Krzysztof", "Tomasz", "Marcin", "Michał",
    "Kamil", "Jakub", "Adam", "Łukasz", "Mateusz", "Wojciech", "Marek", "Grzegorz",
    "Rafał", "Dariusz", "Bartosz", "Maciej", "Mariusz", "Jacek", "Artur", "Robert",
    "Zbigniew", "Stanisław", "Jerzy", "Tadeusz", "Zenon", "Zdzisław", "Kazimierz",
    "Władysław", "Bogdan", "Ryszard", "Henryk", "Janusz", "Mirosław", "Leszek",
    "Czesław", "Józef", "Witold", "Eugeniusz", "Sławomir", "Ireneusz", "Damian",
    "Sebastian", "Filip", "Karol", "Szymon", "Dawid",

    // Imiona żeńskie (top 50)
    "Anna", "Maria", "Katarzyna", "Małgorzata", "Agnieszka", "Barbara", "Ewa", "Krystyna",
    "Elżbieta", "Magdalena", "Joanna", "Teresa", "Zofia", "Jadwiga", "Danuta", "Irena",
    "Halina", "Helena", "Beata", "Aleksandra", "Dorota", "Jolanta", "Renata", "Grażyna",
    "Stanisława", "Wanda", "Janina", "Marianna", "Urszula", "Bożena", "Iwona", "Justyna",
    "Monika", "Sylwia", "Karolina", "Natalia", "Paulina", "Weronika", "Martyna", "Agata",
    "Julia", "Zuzanna", "Oliwia", "Maja", "Lena", "Alicja", "Amelia", "Nikola", "Wiktoria", "Emilia",
];
...
pub const COMMON_POLISH_SURNAMES: &[&str] = &[
    ...
    "Zakrzewski", "Kołodziej", "Sikorski", "Krajewski", "Gajewski", "Szymczak", "Laskowski",
    "Ziółkowski", "Makowski", "Baranowski", "Urbanek", "Kaczmarczyk", "Kozak", "Komiński",
    "Nawrocki", "Przybylski", "Wyszyński", "Markowski", "Małecki", "Kasprzak",
];
...
const POLISH_SURNAME_SUFFIXES: &[&str] = &[
    "dzki", "dzka", "ski", "ska", "cki", "cka",
    "owicz", "ewicz", "wicz", "czyk", "ak", "ek", "ik", "yk",
];
...
fn has_polish_surname_suffix(word: &str) -> bool {
    ...
    POLISH_SURNAME_SUFFIXES.iter().any(|suffix| word.ends_with(suffix))
}
