        ...
        for (table, resource_type, primary_key) in [
            ...
            assert_eq!(
                descriptor
                    ...
                    .unwrap()
                    .as_str(),
                // main put the node environment in front of the org segment
                // while this branch was away; the suffix is still what this
                // test is about.
                "core/env/prod/org/org-default/tentavm"
            );
        }
