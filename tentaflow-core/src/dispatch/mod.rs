...
pub fn variant_name_of(body: &MessageBody) -> &'static str {
    match body {
        ...
        MessageBody::ClusterRdmaConfigureRequestBody(_) => "ClusterRdmaConfigureRequest",
        MessageBody::ClusterRdmaConfigureResponseBody(_) => "ClusterRdmaConfigureResponse",
        MessageBody::ClusterDeployRequestBody(_) => "ClusterDeployRequest",
        MessageBody::ClusterDeployResponseBody(_) => "ClusterDeployResponse",
        MessageBody::ClusterDeployStopRequestBody(_) => "ClusterDeployStopRequest",
        MessageBody::ClusterDeployStopResponseBody(_) => "ClusterDeployStopResponse",
        ...
        MessageBody::TentaNasBody(p) => {
            ...
            match p {
                ...
                Tn::ElasticArrayAddDiskAbortRequest { .. } => "TentaNasElasticArrayAddDiskAbortRequest",
