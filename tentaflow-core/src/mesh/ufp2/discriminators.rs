...
/// - PROVIDER_CREDENTIALS_SYNC (agent-account credentials, sealed per recipient)
pub fn is_migrated_to_ufp2_discriminator(disc: u8) -> bool {
    matches!(
        ...
        legacy::MESH_MSG_HEARTBEAT
            ...
            | legacy::MESH_MSG_PROVIDER_CREDENTIALS_SYNC
...
pub mod kinds {
    ...
    pub const PROVIDER_CREDENTIALS_SYNC: Kind =
        Kind(legacy::MESH_MSG_PROVIDER_CREDENTIALS_SYNC as u16);
