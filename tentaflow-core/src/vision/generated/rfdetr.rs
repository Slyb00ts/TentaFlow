// Generated from ONNX "/tmp/claude-1000/-mnt-abyss-Files-Dokumenty-Praca-Euvic-Tematy-Acme-PoC-AI/8ac0e073-68ff-4807-b1e6-520512a7b517/scratchpad/rfdetr-base-simp.onnx" by burn-onnx
use burn::prelude::*;
...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn forward(
        ...
        let reshape1_out1 = conv2d1_out1.reshape([1, 384, -1]);
        ...
        let reshape2_out1 = slice2_out1.reshape([4, 10, 4, 10, -1]);
        let transpose2_out1 = reshape2_out1.permute([0, 2, 1, 3, 4]);
        let reshape3_out1 = transpose2_out1.reshape([16, 100, -1]);
        ...
        let add3_out1 = (constant64_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split1_out2);
        let reshape4_out1 = add3_out1.reshape([16, 101, 6, 64]);
        let constant65_out1 = self.constant65.val();
        let add4_out1 = (constant65_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split1_out3);
        let reshape5_out1 = add4_out1.reshape([16, 101, 6, 64]);
        let transpose3_out1 = reshape5_out1.permute([0, 2, 1, 3]);
        let reshape6_out1 = add2_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape7_out1 = transpose6_out1.reshape([16, 101, 384]);
        ...
        let add9_out1 = (constant76_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split2_out2);
        let reshape8_out1 = add9_out1.reshape([16, 101, 6, 64]);
        let constant77_out1 = self.constant77.val();
        let add10_out1 = (constant77_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split2_out3);
        let reshape9_out1 = add10_out1.reshape([16, 101, 6, 64]);
        let transpose7_out1 = reshape9_out1.permute([0, 2, 1, 3]);
        let reshape10_out1 = add8_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape11_out1 = transpose10_out1.reshape([16, 101, 384]);
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn forward(
        ...
        let reshape12_out1 = add13_out1.clone().reshape([1, 1616, 384]);
        ...
        let add15_out1 = (constant88_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split3_out2);
        let reshape13_out1 = add15_out1.reshape([1, 1616, 6, 64]);
        let constant89_out1 = self.constant89.val();
        let add16_out1 = (constant89_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split3_out3);
        let reshape14_out1 = add16_out1.reshape([1, 1616, 6, 64]);
        let transpose11_out1 = reshape14_out1.permute([0, 2, 1, 3]);
        let reshape15_out1 = add14_out1.reshape([1, 1616, 6, 64]);
        ...
        let reshape16_out1 = transpose14_out1.reshape([1, 1616, 384]);
        let linear10_out1 = self.linear10.forward(reshape16_out1);
        let reshape17_out1 = linear10_out1.reshape([16, 101, 384]);
        ...
        let add21_out1 = (constant100_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split4_out2);
        let reshape18_out1 = add21_out1.reshape([16, 101, 6, 64]);
        let constant101_out1 = self.constant101.val();
        let add22_out1 = (constant101_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split4_out3);
        let reshape19_out1 = add22_out1.reshape([16, 101, 6, 64]);
        let transpose15_out1 = reshape19_out1.permute([0, 2, 1, 3]);
        let reshape20_out1 = add20_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape21_out1 = transpose18_out1.reshape([16, 101, 384]);
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn forward(
        ...
        let add27_out1 = (constant112_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split5_out2);
        let reshape22_out1 = add27_out1.reshape([16, 101, 6, 64]);
        let constant113_out1 = self.constant113.val();
        let add28_out1 = (constant113_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split5_out3);
        let reshape23_out1 = add28_out1.reshape([16, 101, 6, 64]);
        let transpose19_out1 = reshape23_out1.permute([0, 2, 1, 3]);
        let reshape24_out1 = add26_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape25_out1 = transpose22_out1.reshape([16, 101, 384]);
        ...
        let reshape26_out1 = add31_out1.clone().reshape([1, 1616, 384]);
        ...
        let add33_out1 = (constant124_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split6_out2);
        let reshape27_out1 = add33_out1.reshape([1, 1616, 6, 64]);
        let constant125_out1 = self.constant125.val();
        let add34_out1 = (constant125_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split6_out3);
        let reshape28_out1 = add34_out1.reshape([1, 1616, 6, 64]);
        let transpose23_out1 = reshape28_out1.permute([0, 2, 1, 3]);
        let reshape29_out1 = add32_out1.reshape([1, 1616, 6, 64]);
...
impl<B: Backend> Submodule4<B> {
    ...
    pub fn forward(
        ...
        let reshape30_out1 = transpose26_out1.reshape([1, 1616, 384]);
        let linear22_out1 = self.linear22.forward(reshape30_out1);
        let reshape31_out1 = linear22_out1.reshape([16, 101, 384]);
        ...
        let add39_out1 = (constant136_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split7_out2);
        let reshape32_out1 = add39_out1.reshape([16, 101, 6, 64]);
        let constant137_out1 = self.constant137.val();
        let add40_out1 = (constant137_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split7_out3);
        let reshape33_out1 = add40_out1.reshape([16, 101, 6, 64]);
        let transpose27_out1 = reshape33_out1.permute([0, 2, 1, 3]);
        let reshape34_out1 = add38_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape35_out1 = transpose30_out1.reshape([16, 101, 384]);
        ...
        let add45_out1 = (constant148_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split8_out2);
        let reshape36_out1 = add45_out1.reshape([16, 101, 6, 64]);
        let constant149_out1 = self.constant149.val();
        let add46_out1 = (constant149_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split8_out3);
        let reshape37_out1 = add46_out1.reshape([16, 101, 6, 64]);
        let transpose31_out1 = reshape37_out1.permute([0, 2, 1, 3]);
        let reshape38_out1 = add44_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape39_out1 = transpose34_out1.reshape([16, 101, 384]);
        ...
        let reshape40_out1 = add49_out1.clone().reshape([1, 1616, 384]);
        ...
        let add51_out1 = (constant160_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split9_out2);
        let reshape41_out1 = add51_out1.reshape([1, 1616, 6, 64]);
        let constant161_out1 = self.constant161.val();
        let add52_out1 = (constant161_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split9_out3);
        let reshape42_out1 = add52_out1.reshape([1, 1616, 6, 64]);
        let transpose35_out1 = reshape42_out1.permute([0, 2, 1, 3]);
        let reshape43_out1 = add50_out1.reshape([1, 1616, 6, 64]);
        ...
        let reshape44_out1 = transpose38_out1.reshape([1, 1616, 384]);
        let linear34_out1 = self.linear34.forward(reshape44_out1);
        let reshape45_out1 = linear34_out1.reshape([16, 101, 384]);
        ...
        let add57_out1 = (constant172_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split10_out2);
        let reshape46_out1 = add57_out1.reshape([16, 101, 6, 64]);
        let constant173_out1 = self.constant173.val();
        let add58_out1 = (constant173_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split10_out3);
        let reshape47_out1 = add58_out1.reshape([16, 101, 6, 64]);
        let transpose39_out1 = reshape47_out1.permute([0, 2, 1, 3]);
        let reshape48_out1 = add56_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape49_out1 = transpose42_out1.reshape([16, 101, 384]);
        ...
        let add63_out1 = (constant184_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split11_out2);
        let reshape50_out1 = add63_out1.reshape([16, 101, 6, 64]);
        let constant185_out1 = self.constant185.val();
        let add64_out1 = (constant185_out1)
            .unsqueeze_dims(&[0isize, 1isize])
            .add(split11_out3);
        let reshape51_out1 = add64_out1.reshape([16, 101, 6, 64]);
        let transpose43_out1 = reshape51_out1.permute([0, 2, 1, 3]);
        let reshape52_out1 = add62_out1.reshape([16, 101, 6, 64]);
        ...
        let reshape53_out1 = transpose46_out1.reshape([16, 101, 384]);
        ...
        let reshape54_out1 = slice3_out1.reshape([-1, 4, 10, 10, 384]);
        let transpose47_out1 = reshape54_out1.permute([0, 2, 1, 3, 4]);
        let reshape55_out1 = transpose47_out1.reshape([1, 40, 40, -1]);
        ...
        let reshape56_out1 = slice4_out1.reshape([-1, 4, 10, 10, 384]);
        let transpose49_out1 = reshape56_out1.permute([0, 2, 1, 3, 4]);
        let reshape57_out1 = transpose49_out1.reshape([1, 40, 40, -1]);
        ...
        let reshape58_out1 = slice5_out1.reshape([-1, 4, 10, 10, 384]);
        let transpose51_out1 = reshape58_out1.permute([0, 2, 1, 3, 4]);
        let reshape59_out1 = transpose51_out1.reshape([1, 40, 40, -1]);
        ...
        let reshape60_out1 = slice6_out1.reshape([-1, 4, 10, 10, 384]);
        let transpose53_out1 = reshape60_out1.permute([0, 2, 1, 3, 4]);
        let reshape61_out1 = transpose53_out1.reshape([1, 40, 40, -1]);
...
pub struct Submodule5<B: Backend> {
    ...
    constant352: burn::module::Param<Tensor<B, 3, Bool>>,
    linear45: Linear<B>,
    ...
    linear48: Linear<B>,
    linear49: Linear<B>,
    constant353: burn::module::Param<Tensor<B, 3>>,
    constant354: burn::module::Param<Tensor<B, 3>>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
    device: B::Device,
}
impl<B: Backend> Submodule5<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let layernormalization35 = LayerNormConfig::new(256)
            ...
            .with_bias(true)
            .init(device);
        let constant352: burn::module::Param<Tensor<B, 3, Bool>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                3,
            ...
            >::empty(
                [1, 1600, 1],
                (device, burn::tensor::DType::Bool(burn::tensor::BoolStore::U32)),
            ),
            device.clone(),
            false,
            [1, 1600, 1].into(),
        ...
        let constant353: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([1, 1600, 2], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [1, 1600, 2].into(),
        );
        let constant354: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                3,
    ...
    pub fn forward(&self, concat3_out1: Tensor<B, 4>) -> (Tensor<B, 3>, Tensor<B, 3>) {
        ...
        let reshape62_out1 = transpose72_out1.reshape([1, 256, -1]);
        ...
        let where1_out1 = transpose73_out1
            .clone()
            .mask_fill(constant352_out1, constant315_out1);
        ...
        let mul75_out1 = slice7_out1.mul(constant353_out1.clone());
        let constant354_out1 = self.constant354.val();
        let add68_out1 = mul75_out1.add(constant354_out1);
        let slice8_out1 = linear49_out1.slice(s![.., .., 2..]);
        let exp1_out1 = slice8_out1.exp();
        let mul76_out1 = exp1_out1.mul(constant353_out1);
...
pub struct Submodule6<B: Backend> {
    ...
    linear50: Linear<B>,
    linear51: Linear<B>,
    constant355: burn::module::Param<Tensor<B, 3>>,
    phantom: core::marker::PhantomData<B>,
    #[module(skip)]
    device: B::Device,
}
impl<B: Backend> Submodule6<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        let constant356: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            ...
            move |device, _require_grad| Tensor::<
                B,
                3,
            >::zeros([1, 300, 2], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [1, 300, 2].into(),
        );
        ...
        let constant355: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                3,
    ...
    pub fn forward(
        ...
        let mul77_out1 = constant356_out1.mul(slice9_out1.clone());
        ...
        let mul78_out1 = constant357_out1.mul(slice9_out1);
        ...
        let reshape63_out1 = concat7_out1.reshape([1, 300, -1]);
        ...
        let reshape64_out1 = concat8_out1.reshape([1, 300, -1]);
        let gather3_out1 = {
        ...
        let reshape65_out1 = concat9_out1.reshape([1, 300, -1]);
        let gather4_out1 = {
        ...
        let reshape66_out1 = concat10_out1.reshape([1, 300, -1]);
        ...
        (constant355_out1, linear51_out1, slice11_out1, concat6_out1)
    }
}
#[derive(Module, Debug)]
pub struct Submodule7<B: Backend> {
    linear52: Linear<B>,
    linear53: Linear<B>,
    constant366: burn::module::Param<Tensor<B, 4>>,
    linear54: Linear<B>,
...
impl<B: Backend> Submodule7<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let constant366: burn::module::Param<Tensor<B, 4>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| Tensor::<
                B,
                4,
            >::zeros([1, 8, 300, 32], (device, burn::tensor::DType::F32)),
            device.clone(),
            false,
            [1, 8, 300, 32].into(),
        );
    ...
    pub fn forward(
        ...
        let add70_out1 = constant355_out1.clone().add(linear51_out1.clone());
        ...
        let constant366_out1 = self.constant366.val();
        let (matmul77_out1,) = {
            let q = reshape69_out1;
            let k = reshape70_out1;
            let v = constant366_out1;
        ...
        let add71_out1 = constant355_out1.add(transpose79_out1);
        ...
        let reshape75_out1 = transpose80_out1.reshape([1, 16, 16, 1600]);
        ...
        let reshape76_out1 = slice22_out1.reshape([16, 16, 40, 40]);
        let gather5_out1 = {
        ...
        let reshape79_out1 = unsqueeze15_out1.reshape([16, 16, 300, -1]);
        let mul88_out1 = reshape79_out1.mul(reshape78_out1);
        let reducesum1_out1 = {
            mul88_out1.sum_dim(3usize).squeeze_dims::<3usize>(&[3])
        };
        let reshape80_out1 = reducesum1_out1.reshape([1, 256, 300]);
...
impl<B: Backend> Submodule8<B> {
    ...
    pub fn forward(
        ...
        let reshape91_out1 = transpose92_out1.reshape([1, 16, 16, 1600]);
        ...
        let reshape92_out1 = slice23_out1.reshape([16, 16, 40, 40]);
        let gather6_out1 = {
        ...
        let reshape95_out1 = unsqueeze16_out1.reshape([16, 16, 300, -1]);
        let mul94_out1 = reshape95_out1.mul(reshape94_out1);
        let reducesum2_out1 = {
            mul94_out1.sum_dim(3usize).squeeze_dims::<3usize>(&[3])
        };
        let reshape96_out1 = reducesum2_out1.reshape([1, 256, 300]);
        ...
        let reshape107_out1 = transpose104_out1.reshape([1, 16, 16, 1600]);
        ...
        let reshape108_out1 = slice24_out1.reshape([16, 16, 40, 40]);
        let gather7_out1 = {
        ...
        let reshape111_out1 = unsqueeze17_out1.reshape([16, 16, 300, -1]);
        let mul100_out1 = reshape111_out1.mul(reshape110_out1);
        let reducesum3_out1 = {
            mul100_out1.sum_dim(3usize).squeeze_dims::<3usize>(&[3])
        };
        let reshape112_out1 = reducesum3_out1.reshape([1, 256, 300]);
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file(
            "/tmp/onnx2gen-1723799-rfdetr-base-simp/rfdetr-base-simp.bpk",
            &Default::default(),
        )
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn forward(&self, input: Tensor<B, 4>) -> (Tensor<B, 3>, Tensor<B, 3>) {
        ...
        let (constant355_out1, linear51_out1, slice11_out1, concat6_out1) = self
            .submodule6
