...
impl<B: Backend> Submodule1<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        let conv2d1 = Conv2dConfig::new([3, 384], [14, 14])
            ...
            .with_bias(true)
            .init(device);
        let constant295: burn::module::Param<Tensor<B, 1, Int>> =
        ...
        let constant1: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 3>::zeros([1, 1, 384], (device, burn::tensor::DType::F32))
            },
            device.clone(),
            false,
            [1, 1, 384].into(),
        ...
        let constant211: burn::module::Param<Tensor<B, 3>> = burn::module::Param::uninitialized(
            burn::module::ParamId::new(),
            move |device, _require_grad| {
                Tensor::<B, 3>::zeros([1, 1369, 384], (device, burn::tensor::DType::F32))
            },
            device.clone(),
            false,
            [1, 1369, 384].into(),
    ...
    pub fn forward(&self, pixel_values: Tensor<B, 4>) -> (Tensor<B, 3>, [i64; 4]) {
        ...
        let constantofshape1_out1 = Tensor::<B, 1, Int>::from_data(
        ...
        let where1_out1 = Tensor::<B, 1, burn::tensor::Int>::from_data(
        ...
        let concat8_out1 = burn::tensor::Tensor::cat([constant210_out1, reshape4_out1].into(), 1);
        ...
        let mul2_out1 =
            transpose5_out1.mul((constant326_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant327_out1 = self.constant327.val();
        let mul3_out1 =
            transpose6_out1.mul((constant327_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul4_out1 = linear4_out1.mul((constant10_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule2<B> {
    ...
    pub fn forward(&self, add2_out1: Tensor<B, 3>) -> Tensor<B, 3> {
        ...
        let add3_out1 = erf1_out1.add((constant334_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul5_out1 = linear5_out1.mul(add3_out1);
        let constant335_out1 = self.constant335.val();
        let mul6_out1 = mul5_out1.mul((constant335_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear6_out1 = self.linear6.forward(mul6_out1);
        let constant15_out1 = self.constant15.val();
        let mul7_out1 = linear6_out1.mul((constant15_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul8_out1 =
            transpose9_out1.mul((constant349_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant350_out1 = self.constant350.val();
        let mul9_out1 =
            transpose10_out1.mul((constant350_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul10_out1 = linear10_out1.mul((constant22_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add6_out1 = erf2_out1.add((constant357_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul11_out1 = linear11_out1.mul(add6_out1);
        let constant358_out1 = self.constant358.val();
        let mul12_out1 = mul11_out1.mul((constant358_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear12_out1 = self.linear12.forward(mul12_out1);
        let constant27_out1 = self.constant27.val();
        let mul13_out1 = linear12_out1.mul((constant27_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule3<B> {
    ...
    pub fn forward(&self, add7_out1: Tensor<B, 3>) -> (Tensor<B, 4>, Tensor<B, 3>) {
        ...
        let mul14_out1 =
            transpose13_out1.mul((constant372_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant373_out1 = self.constant373.val();
        let mul15_out1 =
            transpose14_out1.mul((constant373_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul16_out1 = linear16_out1.mul((constant34_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add9_out1 = erf3_out1.add((constant380_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul17_out1 = linear17_out1.mul(add9_out1);
        let constant381_out1 = self.constant381.val();
        let mul18_out1 = mul17_out1.mul((constant381_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear18_out1 = self.linear18.forward(mul18_out1);
        let constant39_out1 = self.constant39.val();
        let mul19_out1 = linear18_out1.mul((constant39_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul20_out1 =
            transpose17_out1.mul((constant395_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant396_out1 = self.constant396.val();
        let mul21_out1 =
            transpose18_out1.mul((constant396_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
...
impl<B: Backend> Submodule4<B> {
    ...
    #[allow(clippy::let_and_return, clippy::approx_constant)]
    pub fn forward(&self, matmul29_out1: Tensor<B, 4>, add10_out1: Tensor<B, 3>) -> Tensor<B, 3> {
        ...
        let mul22_out1 = linear22_out1.mul((constant46_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add12_out1 = erf4_out1.add((constant403_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul23_out1 = linear23_out1.mul(add12_out1);
        let constant404_out1 = self.constant404.val();
        let mul24_out1 = mul23_out1.mul((constant404_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear24_out1 = self.linear24.forward(mul24_out1);
        let constant51_out1 = self.constant51.val();
        let mul25_out1 = linear24_out1.mul((constant51_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul26_out1 =
            transpose21_out1.mul((constant418_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant419_out1 = self.constant419.val();
        let mul27_out1 =
            transpose22_out1.mul((constant419_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul28_out1 = linear28_out1.mul((constant58_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule5<B> {
    ...
    pub fn forward(&self, add14_out1: Tensor<B, 3>) -> Tensor<B, 3> {
        ...
        let add15_out1 = erf5_out1.add((constant426_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul29_out1 = linear29_out1.mul(add15_out1);
        let constant427_out1 = self.constant427.val();
        let mul30_out1 = mul29_out1.mul((constant427_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear30_out1 = self.linear30.forward(mul30_out1);
        let constant63_out1 = self.constant63.val();
        let mul31_out1 = linear30_out1.mul((constant63_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul32_out1 =
            transpose25_out1.mul((constant441_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant442_out1 = self.constant442.val();
        let mul33_out1 =
            transpose26_out1.mul((constant442_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul34_out1 = linear34_out1.mul((constant70_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add18_out1 = erf6_out1.add((constant449_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul35_out1 = linear35_out1.mul(add18_out1);
        let constant450_out1 = self.constant450.val();
        let mul36_out1 = mul35_out1.mul((constant450_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear36_out1 = self.linear36.forward(mul36_out1);
        let constant75_out1 = self.constant75.val();
        let mul37_out1 = linear36_out1.mul((constant75_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule6<B> {
    ...
    pub fn forward(&self, add19_out1: Tensor<B, 3>) -> Tensor<B, 3> {
        ...
        let mul38_out1 =
            transpose29_out1.mul((constant464_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant465_out1 = self.constant465.val();
        let mul39_out1 =
            transpose30_out1.mul((constant465_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul40_out1 = linear40_out1.mul((constant82_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add21_out1 = erf7_out1.add((constant472_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul41_out1 = linear41_out1.mul(add21_out1);
        let constant473_out1 = self.constant473.val();
        let mul42_out1 = mul41_out1.mul((constant473_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear42_out1 = self.linear42.forward(mul42_out1);
        let constant87_out1 = self.constant87.val();
        let mul43_out1 = linear42_out1.mul((constant87_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul44_out1 =
            transpose33_out1.mul((constant487_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant488_out1 = self.constant488.val();
        let mul45_out1 =
            transpose34_out1.mul((constant488_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul46_out1 = linear46_out1.mul((constant94_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule7<B> {
    ...
    pub fn forward(&self, add23_out1: Tensor<B, 3>) -> Tensor<B, 3> {
        ...
        let add24_out1 = erf8_out1.add((constant495_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul47_out1 = linear47_out1.mul(add24_out1);
        let constant496_out1 = self.constant496.val();
        let mul48_out1 = mul47_out1.mul((constant496_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear48_out1 = self.linear48.forward(mul48_out1);
        let constant99_out1 = self.constant99.val();
        let mul49_out1 = linear48_out1.mul((constant99_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul50_out1 =
            transpose37_out1.mul((constant510_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant511_out1 = self.constant511.val();
        let mul51_out1 =
            transpose38_out1.mul((constant511_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul52_out1 = linear52_out1.mul((constant106_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add27_out1 = erf9_out1.add((constant518_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul53_out1 = linear53_out1.mul(add27_out1);
        let constant519_out1 = self.constant519.val();
        let mul54_out1 = mul53_out1.mul((constant519_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear54_out1 = self.linear54.forward(mul54_out1);
        let constant111_out1 = self.constant111.val();
        let mul55_out1 = linear54_out1.mul((constant111_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule8<B> {
    ...
    pub fn forward(
        ...
        let mul56_out1 =
            transpose41_out1.mul((constant533_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant534_out1 = self.constant534.val();
        let mul57_out1 =
            transpose42_out1.mul((constant534_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul58_out1 = linear58_out1.mul((constant118_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add30_out1 = erf10_out1.add((constant541_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul59_out1 = linear59_out1.mul(add30_out1);
        let constant542_out1 = self.constant542.val();
        let mul60_out1 = mul59_out1.mul((constant542_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear60_out1 = self.linear60.forward(mul60_out1);
        let constant123_out1 = self.constant123.val();
        let mul61_out1 = linear60_out1.mul((constant123_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul62_out1 =
            transpose45_out1.mul((constant556_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant557_out1 = self.constant557.val();
        let mul63_out1 =
            transpose46_out1.mul((constant557_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul64_out1 = linear64_out1.mul((constant130_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add33_out1 = erf11_out1.add((constant564_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul65_out1 = linear65_out1.mul(add33_out1);
        let constant565_out1 = self.constant565.val();
        let mul66_out1 = mul65_out1.mul((constant565_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear66_out1 = self.linear66.forward(mul66_out1);
        let constant135_out1 = self.constant135.val();
        let mul67_out1 = linear66_out1.mul((constant135_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let mul68_out1 =
            transpose49_out1.mul((constant579_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        let constant580_out1 = self.constant580.val();
        let mul69_out1 =
            transpose50_out1.mul((constant580_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
        ...
        let mul70_out1 = linear70_out1.mul((constant142_out1).unsqueeze_dims(&[0isize, 1isize]));
        ...
        let add36_out1 = erf12_out1.add((constant587_out1).unsqueeze_dims(&[0isize, 1isize]));
        let mul71_out1 = linear71_out1.mul(add36_out1);
        let constant588_out1 = self.constant588.val();
        let mul72_out1 = mul71_out1.mul((constant588_out1).unsqueeze_dims(&[0isize, 1isize]));
        let linear72_out1 = self.linear72.forward(mul72_out1);
        let constant147_out1 = self.constant147.val();
        let mul73_out1 = linear72_out1.mul((constant147_out1).unsqueeze_dims(&[0isize, 1isize]));
...
impl<B: Backend> Submodule9<B> {
    ...
    pub fn forward(
        ...
        let mul74_out1 =
            sigmoid1_out1.mul((constant659_out1).unsqueeze_dims(&[0isize, 1isize, 2isize]));
...
impl<B: Backend> Model<B> {
    ...
    pub fn forward(&self, pixel_values: Tensor<B, 4>) -> Tensor<B, 3> {
        ...
        let (reshape56_out1, convtranspose2d1_out1, convtranspose2d2_out1, conv2d4_out1) = self
            .submodule8
            .forward(add28_out1, add10_out1, add19_out1, shape1_out1);
        let squeeze1_out1 = self.submodule9.forward(
            reshape56_out1,
            convtranspose2d1_out1,
            convtranspose2d2_out1,
            conv2d4_out1,
