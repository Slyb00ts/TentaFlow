# ===== File: build_q6k_native.mojo — isolated AOT build of the native Q6_K int8 GEMM PTX =====
# The full build_kernels.mojo cannot run in this toolchain because the fp8 mma
# kernels emit PTX ISA 8.1 which the local ptxas rejects; those PTX are already
# committed. This isolated driver compiles ONLY the portable int8 Q6_K native GEMM
# instances so they can be regenerated without the fp8 dependency. It reuses
# build_kernels' _finalize retarget + manifest-fragment convention
# (sm_89 → sm_80 for these portable int8 tiles).
...
def main() raises:
    ...
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m128, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m128.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m128"))
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m256, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m256.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m256"))
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m512, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m512.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m512"))
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m1024, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m1024.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m1024"))
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m2048, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m2048.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m2048"))
    _ = ctx.compile_function[gemm_q6k_i8_native_4096_14336_m4096, dump_asm=Path("gemm_q6k_i8_native_4096_14336_m4096.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_4096_14336_m4096"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m128, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m128.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_1024_4096_m128"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m256, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m256.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_1024_4096_m256"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m512, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m512.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_1024_4096_m512"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m1024, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m1024.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_1024_4096_m1024"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m2048, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m2048.ptx")]()
    entries.append(_finalize(out_dir, "gemm_q6k_i8_native_1024_4096_m2048"))
    _ = ctx.compile_function[gemm_q6k_i8_native_1024_4096_m4096, dump_asm=Path("gemm_q6k_i8_native_1024_4096_m4096.ptx")]()
    ...
    for i in range(len(entries)):
        ...
        if i + 1 < len(entries):
            frag += ","
        frag += "\n"
    (out_dir / "manifest_q6k_native.json").write_text(frag)
    print("fragment written:", String(out_dir / "manifest_q6k_native.json"))
