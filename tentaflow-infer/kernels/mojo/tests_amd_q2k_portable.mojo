# Golden test PRZENOSNEGO kafla (bez jednostki macierzowej) Q2_K WMMA: wynik GPU wobec referencji liczonej na hoscie
# dokladnie ta sama formula co `gemm_q5_k_impl` (q5 * d*sc - dmin*mn).
from std.gpu.host import DeviceContext
from std.random import random_si64, seed

from src.gemm_q2_k_wmma import gemm_q2_k_tile_f16_bm32
...
def run(ctx: DeviceContext, n_rows: Int, n_cols: Int, n_tokens: Int) raises:
    ...
    comptime BM = 32
    comptime BN = 64
    ctx.enqueue_function[gemm_q2_k_tile_f16_bm32](
