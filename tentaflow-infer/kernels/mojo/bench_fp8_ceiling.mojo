...
def mma_mxfp4_k64(
    ...
    `ptxas` przyjmuje ten wariant na sm_121a; natywne NVFP4 ze skalami e4m3
    odrzuca. Przerabia dwa razy wiecej K na instrukcje niz FP8, wiec jesli
    wykonuje sie w tym samym czasie, daje dwukrotnosc.
    """
    return inlined_assembly[
        (
