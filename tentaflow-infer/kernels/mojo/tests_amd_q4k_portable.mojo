# Golden test PRZENOSNEGO kafla (bez jednostki macierzowej) Q4_K WMMA: wynik GPU wobec referencji liczonej na hoscie
# dokladnie ta sama formula co `_dequant_q4k` (nibble * d*sc - dmin*mn).
from std.gpu.host import DeviceContext
from std.random import random_si64, seed

from src.gemm_q4_k_wmma import gemm_q4_k_tile_f16_bm32
...
def run(ctx: DeviceContext, n_rows: Int, n_cols: Int, n_tokens: Int) raises:
    ...
    comptime BM = 32
    comptime BN = 64
    ctx.enqueue_function[gemm_q4_k_tile_f16_bm32](
