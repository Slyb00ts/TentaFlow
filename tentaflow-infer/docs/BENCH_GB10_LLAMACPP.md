...
1. **MoE nie ma wsadowego dekodowania.** `batched_decode` odrzuca MoE, więc agregat
   stoi na poziomie pojedynczego strumienia: Qwen3-30B 88 wobec 238 tok/s przy
   ośmiu sekwencjach, MXFP4 60 wobec 228.
